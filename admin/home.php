        ...
        <div class="col-xs-12" >
          <h3> <b>VOTES TALLY
            <span class="pull-right">
              ...
              <a href="javascript:void(0);" id="printButton" class="btn btn-success btn-sm btn-curve" style="background-color: #2E8B57 ;color:black ; font-size: 12px; font-family:Times "><span class="glyphicon glyphicon-print"></span> Print</a>
            </span>
         </b> </h3>
        </div>
      </div>
