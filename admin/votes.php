          ...
          <div class="box" style="background-color: #d8d1bd">
            ...
            <div class="box-body">
              <table id="example1" class="table ">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidates.firstname AS canfirst, candidates.lastname AS canlast, voters_detail.firstname AS votfirst, voters_detail.lastname AS votlast 
                            FROM votes 
                            LEFT JOIN positions ON positions.id=votes.position_id 
                            LEFT JOIN candidates ON candidates.id=votes.candidate_id 
                            LEFT JOIN voters_detail ON voters_detail.voters_id=votes.voters_id 
