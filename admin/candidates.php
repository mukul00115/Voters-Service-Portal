...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#F1E9D2; padding: 20px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb" style="color:black; font-size: 17px; font-family:Times;">
        <li><a href="index.php" style="color: #000;"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="background-color: #d8d1bd; border-radius: 10px; padding: 20px;">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <th class="hidden"></th>
                  <th style="background-color: #4682B4; color: white;">Position</th>
                  <th style="background-color: #4682B4; color: white;">Photo</th>
                  <th style="background-color: #4682B4; color: white;">Firstname</th>
                  <th style="background-color: #4682B4; color: white;">Lastname</th>
                  <th style="background-color: #4682B4; color: white;">Platform</th>
                  <th style="background-color: #4682B4; color: white;">Tools</th>
                </thead>
                <tbody>
                  <?php
